(()=>{
  ...
  function mount(){
    const page=qs('#page-english'),hub=qs('#page-english .el6-hub');if(!page||!hub||page.dataset.el7||hub.querySelector('.el8-today-nav,.el9-today-nav'))return false;page.dataset.el7='1';
